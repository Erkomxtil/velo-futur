...
export const ContactAddress = () => {
  return (
    <div>
      <p  className="border-b-[1px] border-[#EFEFEF] border-solid pb-8">Situé sur la rue du Barreau Vert à 150 mètres de Gedimat et 260 mètres de la caisse d&#39;épargne.</p>
      <div className="flex gap-10 pt-5">
        ...
        <div>
          ...
          <a className="mt-5 block" href="https://www.google.com/maps/place/46%C2%B018'24.9%22N+1%C2%B039'59.1%22E/@46.3070896,1.6658768,149m/data=!3m1!1e3!4m4!3m3!8m2!3d46.3069167!4d1.6664167?entry=ttu" target="_blank">Voir sur une carte</a>
        </div>
      </div>
    </div>
  );
